...
export function detectDuplicateCode(
  ...
  for (let i = 0; i < blocks.length; i++) {
    ...
    if (duplicates.length > 0) {
      ...
      detections.push({
        id: `duplicate-code-${filePath}-${block1.startLine || 0}`,
        ...
        filePath,
        loc: {
          start: { line: block1.startLine || 0, column: block1.startColumn || 0 },
          end: { line: block1.endLine || 0, column: block1.endColumn || 0 },
        },
        metadata: {
